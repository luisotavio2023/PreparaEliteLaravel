...
<body class="d-flex flex-column min-vh-100">
        ...
        <div class="row row-cols-2 row-cols-md-6 g-3">
            ...
            <div class="col">
                <div class="card h-100 shadow-sm">
                    <img src="https://preview.redd.it/special-operations-of-the-s%C3%A3o-paulo-military-police-gate-v0-lo8kxfd63n871.jpg?width=640&crop=smart&auto=webp&s=ae66ee1b86c4c62c025eefaef3b6a5c3775bc8b2" class="card-img-top curso-card-img" alt="PMESP" style="height: 200px; object-fit: cover;">
            ...
            <div class="col">
                <div class="card h-100 shadow-sm">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTjFAhbpHCxH1Cd2i42YVHKp_0MLEe07vAufA&s" alt="PC SP" style="height: 200px; object-fit: cover;">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col">
                <div class="card h-100 shadow-sm">
                    <img src="https://portal.estrategia.com/wp-content/uploads/2024/09/o-que-e-prf-profissional-da-prf-em-uma-das-principais-rodovias-do-brasil.jpg" class="card-img-top curso-card-img" alt="PRF"style="height: 200px; object-fit: cover;">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col">
                <div class="card h-100 shadow-sm">
                    <img src="https://omentorconcursos.com.br/wp-content/uploads/2023/07/PF-ou-PRF.webp" class="card-img-top curso-card-img" alt="PF" style="height: 200px; object-fit: cover;">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col">
                <div class="card h-100 shadow-sm">
                    <img src="https://profissaopolicial.com.br/wp-content/uploads/2025/06/CONCURSO-GCM-SP.png" class="card-img-top curso-card-img" alt="PF" style="height: 200px; object-fit: cover;">
                    <div class="card-body d-flex flex-column">
                        <h6 class="fw-bold mb-0">GCM SP</h6>
                        <small class="text-primary fw-semibold">Guarda Civil Municipal de São Paulo</small>
                        <p class="small text-muted mt-2">Sua preparação para o concurso da GCM SP.</p>
                        <a href="#" class="btn btn-primary w-100 mt-auto">Ver Curso</a  >
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100 shadow-sm">
                    <img src="https://blog.solucaopreparatorio.com.br/wp-content/uploads/2020/05/15-duvidas-mais-frequentes-de-concurseiros-1.jpg" class="card-img-top curso-card-img" alt="PF" style="height: 200px; object-fit: cover;">
                    <div class="card-body d-flex flex-column">
                        <h6 class="fw-bold mb-0">Todos os cursos</h6>
                        <small class="text-primary fw-semibold">Explore todas as opções de cursos e carreiras</small>
                        <p class="small text-muted mt-2">Sua preparação para a carreira concursada está aqui!.</p>
                        <a href="#" class="btn btn-primary w-100 mt-auto">Ver Curso</a  >
                    </div>
                </div>
            </div>
    ...
    <!-- MENTORIA INDIVIDUAL -->
    <section class="container-fluid my-4 px-5" style="background-color: #e8f0fb; border-radius: 16px;">
        <div class="row align-items-center">

        <!-- COLUNA ESQUERDA - Texto -->
        <div class="col-md-4 py-4">
            <h2 class="fw-bold">Mentoria Individual</h2>
            <p class="text-primary fw-semibold">Sua aprovação com um plano exclusivo feito para você!</p>
            <p class="text-muted">Acompanhamento personalizado com especialistas, foco nos seus pontos fracos e estratégia de estudos sob medida para o seu concurso.</p>
            <ul class="list-unstyled">
                <li>✅ Plano de estudos personalizado</li>
                <li>✅ Acompanhamento semanal</li>
                <li>✅ Análise de desempenho</li>
                <li>✅ Suporte direto com mentores</li>
            </ul>
        </div>

        <!-- COLUNA CENTRO - Foto -->
        <div class="col-md-4 text-center">
            <img src="https://img.freepik.com/fotos-gratis/closeup-de-freelancer-aprendendo-online-enquanto-usa-laptop-no-escritorio_637285-6405.jpg?semt=ais_hybrid&w=740&q=80" class="img-fluid" alt="Mentor">
        </div>

        <!-- COLUNA DIREITA - Preço -->
        <div class="col-md-4 text-center py-4">
            <div class="bg-white rounded-3 p-4 shadow-sm">
                <h5 class="fw-bold">Assinatura Mensal</h5>
                <h1 class="text-primary fw-bold">R$199,90</h1>
                <p class="text-muted small">Cancelamento fácil e sem burocracia.</p>
                <a href="#" class="btn btn-warning w-100 fw-bold">Quero minha mentoria</a>
            </div>
        </div>
